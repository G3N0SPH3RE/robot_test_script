...
object_table = {
    ...
    'enabled': (1905, 5),
    'status_word_1': (1000, 3),
    'status_word_2': (1000, 4),

    #IEC motion commands
    'axis_command': (1905, 1),
    'position_command': (1901, 1),
    'torque_command': (1901, 1),
    'maximum_position_command': (1901, 2),
    'velocity_command': (1902, 1),
    'maximum_velocity_command': (1902, 1),
    'acceleration_command': (1906, 1),
    'maximum_acceleration_command': (1906, 1),
    'deceleration_command': (1907, 1),
    'maximum_deceleration_command': (1907, 1),
    'jerk_command': (1908, 1),
    'torque_ramp_rate_command': (1908, 1),
...
@dataclass
class AxisTorqueCommand:
    target_torque: float
    maximum_position: float = None
    maximum_velocity: float = None
    maximum_acceleration: float = None
    maximum_deceleration: float = None
    torque_ramp_rate: float = None

    default_value_map: ClassVar[Dict] = {
        #'target_torque': 'default_velocity',
        #'maximum_position': 'default_acceleration',
        'maximum_velocity': 'default_velocity',
        'maximum_acceleration': 'default_acceleration',
        'maximum_deceleration': 'default_deceleration',
...
class RobotMotionCommand:
    x: AxisPositioningCommand = None
    y: AxisPositioningCommand = None
    z: AxisPositioningCommand = None
    c: AxisPositioningCommand = None
...
@dataclass
class StatusWord1Message(AxisStatusFlagMessage, SerialMessage):
    object_index: int = object_table['status_word_1'][0]
    object_subindex: int = object_table['status_word_1'][1]
...
@dataclass
class MaximumPositionMessage(SerialMessage):
    set_value: float = None

    object_index: int = object_table['maximum_position_command'][0]
    object_subindex: int = object_table['maximum_position_command'][1]

@dataclass
class TargetTorqueMessage(SerialMessage):
    set_value: float = None

    object_index: int = object_table['torque_command'][0]
    object_subindex: int = object_table['torque_command'][1]
...
@dataclass
class MaximumVelocityMessage(SerialMessage):
    set_value: float = None

    object_index: int = object_table['maximum_velocity_command'][0]
    object_subindex: int = object_table['maximum_velocity_command'][1]
...
@dataclass
class MaximumAccelerationMessage(SerialMessage):
    set_value: float = None

    object_index: int = object_table['maximum_acceleration_command'][0]
    object_subindex: int = object_table['maximum_acceleration_command'][1]
...
@dataclass
class MaximumDecelerationMessage(SerialMessage):
    set_value: float = None

    object_index: int = object_table['maximum_deceleration_command'][0]
    object_subindex: int = object_table['maximum_deceleration_command'][1]
...
@dataclass
class TorqueRampRateMessage(SerialMessage):
    set_value: float = None

    object_index: int = object_table['torque_ramp_rate_command'][0]
    object_subindex: int = object_table['torque_ramp_rate_command'][1]
...
@dataclass
class AbsolutePositioningModeMessage(SerialMessage):
...
@dataclass
class TorqueModeMessage(SerialMessage):
    set_value: float = command_table['torque_control']
...
update_message_sequence = [
    ...
    {'message_type': StatusWord1Message, 'attribute_name': 'motion_status_bits'},
...
absolute_position_command_message_sequence = [
...
torque_command_message_sequence = [
    {'message_type': TargetTorqueMessage, 'attribute_name': 'torque_command', 'command_attribute_name': 'target_torque'},
    {'message_type': MaximumPositionMessage, 'attribute_name': 'torque_maximum_position_command', 'command_attribute_name': 'maximum_position'},
    {'message_type': MaximumVelocityMessage, 'attribute_name': 'torque_maximum_velocity_command', 'command_attribute_name': 'maximum_velocity'},
    {'message_type': MaximumAccelerationMessage, 'attribute_name': 'torque_maximum_acceleration_command', 'command_attribute_name': 'maximum_acceleration'},
    {'message_type': MaximumDecelerationMessage, 'attribute_name': 'torque_maximum_deceleration_command', 'command_attribute_name': 'maximum_deceleration'},
    {'message_type': TorqueRampRateMessage, 'attribute_name': 'torque_ramp_rate_command', 'command_attribute_name': 'torque_ramp_rate'},
]
...
absolute_position_mode_message_sequence = [
    {'message_type': AbsolutePositioningModeMessage}
]

torque_mode_message_sequence = [
    {'message_type': TorqueModeMessage}
]
