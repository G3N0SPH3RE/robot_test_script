...
class HTTPAxisTorqueCommand(BaseModel):
    target_torque: float
...
class HTTPRobotMotionCommand(BaseModel):
    x: Union[HTTPAxisPositioningCommand, HTTPAxisTorqueCommand] = None
    y: Union[HTTPAxisPositioningCommand, HTTPAxisTorqueCommand] = None
    z: Union[HTTPAxisPositioningCommand, HTTPAxisTorqueCommand] = None
    c: Union[HTTPAxisPositioningCommand, HTTPAxisTorqueCommand] = None
